...
list based on thier CGPA (Cumulative Grade Point Average) in descending order. Each student object
...
# Example usage:
students = [
    Student("Abishek", "A123", 7.8),
    Student("Nithish", "A124", 8.9),
    Student("Ragavi", "A125", 9.1),
    Student("Dhanush", "A126", 9.9),
]
